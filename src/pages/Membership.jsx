                ...
                <form onSubmit={handleSubmit} className="space-y-8 p-6 sm:p-10">
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <input ref={fileInputRef} id="profile" type="file" accept=".pdf,image/jpeg,image/png" onChange={(e)=>setFile(e.target.files[0])} className="mt-2 block w-full text-sm text-slate-600 file:mr-4 file:rounded-lg file:border-0 file:bg-[#143973] file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white file:shadow-sm file:transition hover:file:bg-[#143973]-dark cursor-pointer" />
