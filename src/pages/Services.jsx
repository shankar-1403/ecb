      ...
      <section className="relative overflow-hidden pt-28 pb-12 sm:pt-32 sm:pb-14 md:pt-38 md:pb-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-5 md:px-6 text-center">
          <div>
            <div className="inline-block px-4 py-1.5 rounded-full text-sm font-semibold mb-4" style={{ backgroundColor: "#DAC9EB", color: "#1D2F4F" }}>
              <div className="flex items-center gap-2">
                <div>
                  <Briefcase className="w-3 h-3 shrink-0" style={{ color: "#9B72C4" }} />
                </div>
                <div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight max-w-3xl mx-auto">
            ...
            <span className="bg-linear-to-br from-[#0d2850] via-[#143973] to-[#2563eb] bg-clip-text text-transparent">
              Practical Growth
            </span>
          </h1>
                  ...
                  <div className="relative flex flex-row items-center gap-4 rounded-2xl px-4 py-4 min-h-17 overflow-hidden transition-all duration-300 group-hover:shadow-[0_16px_40px_-8px_rgba(20,57,115,0.25)]" style={{ background: "#ffffff", border: "1px solid rgba(20,57,115,0.25)", boxShadow: "0 4px 24px -4px rgba(0,0,0,0.07)" }}>
                    ...
                    <div className="relative z-10 shrink-0 self-center">
                      <div className="relative flex h-11 w-11 items-center justify-center">
                        ...
                        <motion.div className="relative z-10 group-hover:text-[#1D2F4F] transition-colors duration-300" style={{ color: "#6D28D9" }} animate={{ rotate: [0, 0, 8, -8, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: i * 0.2, times: [0, 0.6, 0.7, 0.85, 1] }}>
